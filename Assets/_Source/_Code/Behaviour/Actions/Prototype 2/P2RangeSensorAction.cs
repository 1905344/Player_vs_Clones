...
[NodeDescription(name: "P2_RangeSensor", story: "Update [P2_Range_Sensor] and assign active [Target]", category: "Action", id: "ee12b085bedc455ebd67265e17e0aac9")]
public partial class P2RangeSensorAction : Action
{
    ...
    {
        //var target = P2_Range_Sensor.Value.GetNearestTarget("Player");
